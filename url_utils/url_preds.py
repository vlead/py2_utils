...
check_url_tar_gz = check(is_url_tar_gz, "invalid tar.gz filename: %")
check_http_tar_gz = check(is_http_tar_gz, "invalid url of tar.gz resource: %")
check_url_fs_path = check(is_url_fs_path, "invalid or non-existent directory: %")
check_url_dir = check(is_url_dir, "invalid or non-existent directory: %")
